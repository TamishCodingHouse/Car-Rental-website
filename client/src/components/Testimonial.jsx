...
const Testimonial = () => {
  ...
  return (
    <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44 cursor-pointer">
      <Title
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
        {testimonials.map((testimonial, index) => (
          <motion.div initial={{ opacity: 0, y: 40 }}
            ...
            transition={{ duration: 0.6, delay: index * 0.2, ease:'easeOut' }} key={index} className="bg-white p-6 rounded-xl shadow-lg hover:-translate-y-1 transition-all duration-500">
